...
public class CrabView {
    ...
    public CrabView(boolean t){
    	//crabs.add(this); 
		oneY = rando(3); //decides random y value
		if(side == true){ //switches spawn side for crabs
			side = false;
			oneX = 1275;
		}
		else{
		...
		cbutton.addMouseListener(new MouseAdapter()  //sets removel variable to true so loop knows to remove
    	{  
