 ...
 *Second level of Garbage Collector
 */
public class GarbageCollector1 extends GarbageCollector {
	 ...
	 */
	public GarbageCollector1(Point loc) { //ranking determines radius, efficiency, rate
		super(loc);
